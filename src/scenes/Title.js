class Title extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('kratos', 'img/kratos.jpg');
        this.load.image('joey', 'img/ce1.jpg');
        this.load.image('obama', 'img/obama.png');
        this.load.image('arto', 'img/arto.jpg');
    ...
    create() {
        // add title text
        this.add.bitmapText(centerX, centerY - 32, 'gem_font', 'MACBETH ACT II SCENE I', 32).setOrigin(0.5);
