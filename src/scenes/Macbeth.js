class Macbeth extends Phaser.Scene {
    ...
    create() {
        ...
        this.obama = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'obama').setOrigin(0, 1);
        this.arto = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'arto').setOrigin(0, 1);
        this.joey = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'joey').setOrigin(0, 1);
        this.kratos = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'kratos').setOrigin(0, 1);
